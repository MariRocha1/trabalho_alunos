...
(105,'introducao a IOT para manutencao indutrial'),
...
insert into alunos
values 
('1100','Mariana', 'Reis Rocha',' 2005-08-17','107');


select cod_aluno,concat('nome','sobrenome')
as 'nome competo', data_nascimento from alunos where data_nascimento>='1999-01-01'
...
select c.cod_curso, c.nome_curso,count(a.cod_curso) as alunos from alunos a
inner join cursos c on c.cod_curso=a.cod_curso group by c.cod_curso;

select a.cod_aluno, concat(a.nome,' ', a.sobrenome) as 'nome completo', c.cod_curso from alunos a 
